...
public class StartScript : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject[] _PlayerPistolPivots;
    [SerializeField]
    private GameObject[] _PlayerCanvasScript = new GameObject[4];

    private int _amountOfPlayers = 0;
    private int _gamestate = 0;
    //private Vector3[] _spawnPos = new Vector3[4]; //
    //private Color[] _playerColor = new Color[4];  //Word niet gebruikt
    [SerializeField]
    ...
    void Start()
    {
        ...
        //_spawnPos[3] = new Vector3(6.13f, -3.44f, -0.68f);   ///Dit stuff word nog niet gebruikt dus ik heb het weg gehaald zodat het makkelijk word voor ons om de script te lezen.
    ...
    void OnGUI()
    {
        ...
        else if (_gamestate == 0)
        {
            ...
            //    temp.transform.position = _spawnPos[i];                     //Dit zijn Object Primitive en dat gebruiken we niet meer.
        ...
        if (_gamestate == 1)
        {
            ...
            _movePlayerScript.Players = _players; //<------------------ Players worden hier toegevoegt in de player[] gameobject in moveplayerscript.
